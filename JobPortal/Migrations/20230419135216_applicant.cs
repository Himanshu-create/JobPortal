        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobAppliedId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicantData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicantData_AspNetUsers_userId",
                        column: x => x.userId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicantData_JobDetails_JobAppliedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicantData_JobAppliedId",
                table: "ApplicantData",
                column: "JobAppliedId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantData_userId",
                table: "ApplicantData",
                column: "userId");
